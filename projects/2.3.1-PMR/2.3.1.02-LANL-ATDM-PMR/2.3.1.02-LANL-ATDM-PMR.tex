\subsubsection{\stid{1.02} LANL ATDM Programming Models and Runtimes}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=4in]{projects/2.3.1-PMR/2.3.1.02-LANL-ATDM-PMR/control-replication-performance}
