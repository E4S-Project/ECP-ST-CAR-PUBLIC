...
\subparagraph{Application Requirements}%\item {\bf Application requirements}
...
\subparagraph{OpenMP Specification Evolution}%\item {\bf OpenMP specification evolution}
...
\subparagraph{LLVM  Compiler}%\item {\bf LLVM  Compiler}
...
\subparagraph{OpenMP Runtime Systems}%\item {\bf OpenMP runtime systems} 
...
\subparagraph{Validation and Verification (V\&V)}%\item {\bf Validation and Verification (V\&V)}
...
\subparagraph{Training and Outreach}%\item{\bf Training and Outreach}
