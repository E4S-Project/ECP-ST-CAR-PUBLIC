...
%TODO: add figures if we receive approval from OLCF 

\begin{figure}
\centering
\includegraphics[width=.45\linewidth]{projects/2.3.1-PMR/2.3.1.09-ParSEC/dgemm_spock.pdf}
\includegraphics[width=.45\linewidth]{projects/2.3.1-PMR/2.3.1.09-ParSEC/dpotrf_spock.pdf}
\includegraphics[width=.45\linewidth]{projects/2.3.1-PMR/2.3.1.09-ParSEC/dpotrf_spock_x4.pdf}
\includegraphics[width=.45\linewidth]{projects/2.3.1-PMR/2.3.1.09-ParSEC/mpqc_spock.pdf}
