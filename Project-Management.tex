...
\iffalse %Converted to editable text below. -STC
\begin{figure}
        \centering
...
\iffalse % Converted figure to a table so it can be edited.
\begin{figure}
	\centering
...
&
An extensible, open architecture software ecosystem that accepts contributions from US and international teams \vspace{0.5em} \\%\hline

& 
A framework for collaborative open-source product integration \\\hline
A monolithic, take-it-or-leave-it software behemoth
& 
A full collection of compatible software capabilities \vspace{0.5em} \\ %\hline
...
& 
The conduit for future-leading edge HPC software that targets scalable, next-generation computing platforms \vspace{0.5em} \\ %\hline
...
\iffalse %Converted to table below, but I also updated this file. Choose your own adventure. -STC
\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{KPP-Definitions}
