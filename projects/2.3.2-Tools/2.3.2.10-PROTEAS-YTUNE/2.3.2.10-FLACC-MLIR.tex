...
\todo{NEEDS updating. this was simply copied from CLACC}
...
\raisebox{-\totalheight}{\includegraphics[scale=.65]{projects/2.3.2-Tools/2.3.2.10-PROTEAS-YTUNE/clacc.png}}
