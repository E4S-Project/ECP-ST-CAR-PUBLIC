...
high-throughput workflows, as well as enabling communication between fine-grained
...
projects and defining new component interfaces. The ExaWorks SDK provides a robust, well-tested,
well-documented,
...
\begin{wrapfigure}
\begin{center}
    \includegraphics[width=0.6\textwidth]{projects/2.3.5-Ecosystem/2.3.5.10-ExaWorks/ExaWorks_Circle.pdf}
  \end{center}
  \vspace{-0.25in}
...
robust workflow component technologiess, explore pairwise integrations between components, and define
common component interfaces for shared components.  The project also aims to impact ECP applications and
...
interoperation testing, but we plan to extend our solutions to ensure scalable
...
we are preparing an ExaWorks tutorial at SC21. We will incorporate the
