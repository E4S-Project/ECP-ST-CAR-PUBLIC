...
‘high-level API’, and several new components, including ROCm and ROCm\_SMI for AMD GPUs, 
powercap\_ppc and sensors\_ppc for IBM Power9 and later, the SDE component to expose 
