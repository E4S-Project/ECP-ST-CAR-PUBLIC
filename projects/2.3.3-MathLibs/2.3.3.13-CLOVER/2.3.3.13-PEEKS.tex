...
\caption{\label{fig:ginkgoportability}The portability design of the Ginkgo math
  library enable high performance kernel implementations in the vendor-supported
...
The Ginkgo team is addressing these challenges by thriving for platform
...
\begin{enumerate}
  ...
  \item \textbf{Sustainability efforts:} Ginkgo adheres the Better Scientific
		...
		packages.
  \item \textbf{Fine-grain parallelism:} Ginkgo features coarse linear algebra
		...
		methods.
  \item \textbf{Mixed precision methods:} Ginkgo features the memory accessor
...
\begin{enumerate}
  \item \textbf{Deployment of multi-node functionality:} Ginkgo already has
		...
		MPI layer. We will harden the support and make it production-ready.
